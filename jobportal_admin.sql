...
CREATE TABLE `admin` (
  ...
  CONSTRAINT `admin_chk_1` CHECK ((`Admin_Status` in (_utf8mb4'Active',_utf8mb4'Inactive')))
...
INSERT INTO `admin` VALUES (4,2,'Admin','admin@example.com','1234567890','Active');
...
-- Dump completed on 2025-03-04  9:12:06
