        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="view_health_report.php?id=<?php echo htmlspecialchars($worker['Worker_ID']); ?>" target="_blank">View Health Report</a></td>
                    <td>
                        <form method="POST">
